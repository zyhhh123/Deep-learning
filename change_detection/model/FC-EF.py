...
class FC_EF(nn.Module):
    def __init__(self,input_channels,label) :
        ...
        self.econv12 = nn.Conv2d(16,label,padding=1)
    ...
    def forward(self,x):
        ...
        pool3 = F.max_pool2d(x3,sdride =2 ,kernel_size= 2)
        ...
        pool4 = F.max_pool2d(x4,sdride =2 ,kernel_size= 2)
